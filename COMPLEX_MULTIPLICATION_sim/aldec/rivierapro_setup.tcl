...
# ACDS 20.1 720 win32 2022.01.07.17:04:48
# ----------------------------------------
...
# ----------------------------------------
# If COMPLEX_MULTIPLICATION is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "COMPLEX_MULTIPLICATION"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/COMPLEX_MULTIPLICATION.vo"
}
